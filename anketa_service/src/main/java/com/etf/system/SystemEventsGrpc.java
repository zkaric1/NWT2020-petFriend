...
public final class SystemEventsGrpc {
    ...
    private static volatile io.grpc.MethodDescriptor<com.etf.system.PetFriend.Request,
            com.etf.system.PetFriend.Response> getLogActionMethod;

    @io.grpc.stub.annotations.RpcMethod(
            fullMethodName = SERVICE_NAME + '/' + "logAction",
            requestType = com.etf.system.PetFriend.Request.class,
            responseType = com.etf.system.PetFriend.Response.class,
            methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
    public static io.grpc.MethodDescriptor<com.etf.system.PetFriend.Request,
            com.etf.system.PetFriend.Response> getLogActionMethod() {
        io.grpc.MethodDescriptor<com.etf.system.PetFriend.Request, com.etf.system.PetFriend.Response> getLogActionMethod;
            ...
            synchronized (SystemEventsGrpc.class) {
                if ((getLogActionMethod = SystemEventsGrpc.getLogActionMethod) == null) {
                    SystemEventsGrpc.getLogActionMethod = getLogActionMethod =
                            io.grpc.MethodDescriptor.<com.etf.system.PetFriend.Request, com.etf.system.PetFriend.Response>newBuilder()
                                    .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
                                    .setFullMethodName(generateFullMethodName(
                                            "SystemEvents", "logAction"))
                                    .setSampledToLocalTracing(true)
                                    .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                                            com.etf.system.PetFriend.Request.getDefaultInstance()))
                                    .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                                            com.etf.system.PetFriend.Response.getDefaultInstance()))
    ...
    public static abstract class SystemEventsImplBase implements io.grpc.BindableService {
        ...
        /**
         */
        public void logAction(com.etf.system.PetFriend.Request request,
                              io.grpc.stub.StreamObserver<com.etf.system.PetFriend.Response> responseObserver) {
        ...
        @Override public final io.grpc.ServerServiceDefinition bindService() {
            return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
                    .addMethod(
                            ...
                            asyncUnaryCall(
                                    new MethodHandlers<
                                            com.etf.system.PetFriend.Request,
                                            com.etf.system.PetFriend.Response>(
    ...
    public static final class SystemEventsBlockingStub extends io.grpc.stub.AbstractStub<SystemEventsBlockingStub> {
        ...
        /**
         */
        public com.etf.system.PetFriend.Response logAction(com.etf.system.PetFriend.Request request) {
    ...
    public static final class SystemEventsFutureStub extends io.grpc.stub.AbstractStub<SystemEventsFutureStub> {
        ...
        /**
         */
        public com.google.common.util.concurrent.ListenableFuture<com.etf.system.PetFriend.Response> logAction(
                com.etf.system.PetFriend.Request request) {
        ...
        public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
            switch (methodId) {
                case METHODID_LOG_ACTION:
                    serviceImpl.logAction((com.etf.system.PetFriend.Request) request,
                            (io.grpc.stub.StreamObserver<com.etf.system.PetFriend.Response>) responseObserver);
                    break;
                default:
    ...
    private static abstract class SystemEventsBaseDescriptorSupplier
        ...
        public com.google.protobuf.Descriptors.FileDescriptor getFileDescriptor() {
            return com.etf.system.PetFriend.getDescriptor();
        }
